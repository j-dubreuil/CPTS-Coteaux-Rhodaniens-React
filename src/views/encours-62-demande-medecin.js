...
const Encours62DemandeMedecin = (props) => {
  return (
    <div className="encours62demande-medecin-container">
        ...
        <div className="encours62demande-medecin-cards-container">
          <div className="encours62demande-medecin-features-card">
            ...
            <div className="encours62demande-medecin-text-container">
              ...
              <span className="encours62demande-medecin-text01 card-Text">
          ...
          <div className="encours62demande-medecin-features-card1">
            ...
            <div className="encours62demande-medecin-text-container1">
              ...
              <span className="encours62demande-medecin-text02 card-Text">
                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer
                nec odio. Praesent libero. Sed cursus ante dapibus diam.c Sed
                nisi. Nulla quis sem at nibh elementum imperdiet.
              </span>
          ...
          <div className="encours62demande-medecin-features-card2">
            ...
            <div className="encours62demande-medecin-text-container2">
              ...
              <span className="encours62demande-medecin-text03 card-Text">
                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer
                nec odio. Praesent libero. Sed cursus ante dapibus diam.c Sed
                nisi. Nulla quis sem at nibh elementum imperdiet.
              </span>
          ...
          <div className="encours62demande-medecin-features-card3">
            ...
            <div className="encours62demande-medecin-text-container3">
              ...
              <span className="encours62demande-medecin-text04 card-Text">
                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer
                nec odio. Praesent libero. Sed cursus ante dapibus diam.c Sed
                nisi. Nulla quis sem at nibh elementum imperdiet.
              </span>
          ...
          <div className="encours62demande-medecin-features-card4">
            ...
            <div className="encours62demande-medecin-text-container4">
              ...
              <span className="encours62demande-medecin-text05 card-Text">
                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer
                nec odio. Praesent libero. Sed cursus ante dapibus diam.c Sed
                nisi. Nulla quis sem at nibh elementum imperdiet.
              </span>
          ...
          <div className="encours62demande-medecin-features-card5">
            ...
            <div className="encours62demande-medecin-text-container5">
              ...
              <span className="encours62demande-medecin-text06 card-Text">
                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer
                nec odio. Praesent libero. Sed cursus ante dapibus diam.c Sed
                nisi. Nulla quis sem at nibh elementum imperdiet.
              </span>
      ...
      <div id="contact" className="encours62demande-medecin-contact">
        <h2 className="encours62demande-medecin-text07 section-Heading">
          - Nous contacter -
        </h2>
        <div className="encours62demande-medecin-content-container">
          <div className="encours62demande-medecin-form-container">
            <span className="encours62demande-medecin-heading6 bigCard-Heading">
            ...
            <input
              ...
              className="encours62demande-medecin-nom input"
            />
            <input
              type="text"
              required="true"
              placeholder="E-mail"
              className="encours62demande-medecin-email input"
            />
            <textarea
              placeholder="Votre message..."
              className="encours62demande-medecin-message textarea"
            ></textarea>
            <button
              type="submit"
              className="encours62demande-medecin-cta-btn anchor button"
            >
              ENVOYER
            </button>
          </div>
          <div className="encours62demande-medecin-locations-container">
            <div className="encours62demande-medecin-location-1">
              <span className="encours62demande-medecin-heading7">Rhône</span>
              <div className="encours62demande-medecin-adresse">
                <svg
                  viewBox="0 0 1024 1024"
                  className="encours62demande-medecin-icon18"
                >
                  <path d="M512 0c-176.732 0-320 143.268-320 320 0 320 320 704 320 704s320-384 320-704c0-176.732-143.27-320-320-320zM512 512c-106.040 0-192-85.96-192-192s85.96-192 192-192 192 85.96 192 192-85.96 192-192 192z"></path>
                </svg>
                <span className="section-Text">69700</span>
              </div>
              <div className="encours62demande-medecin-email1">
                <svg
                  viewBox="0 0 1024 1024"
                  className="encours62demande-medecin-icon20"
                >
                  <path d="M854 342v-86l-342 214-342-214v86l342 212zM854 170q34 0 59 26t25 60v512q0 34-25 60t-59 26h-684q-34 0-59-26t-25-60v-512q0-34 25-60t59-26h684z"></path>
                </svg>
                <a
                  href="mailto:cptscoteauxrhodaniens@gmail.com?subject=Contact site web"
                  className="encours62demande-medecin-link section-Text"
                >
                  cptscoteauxrhodaniens@gmail.com
                </a>
              </div>
              <div className="encours62demande-medecin-phone">
                <svg
                  viewBox="0 0 804.5714285714286 1024"
                  className="encours62demande-medecin-icon22"
                >
